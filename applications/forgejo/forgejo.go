...
func env() docker.Environment {
	return docker.NewEnvironment().
		...
		StringVar("FORGEJO__service__DISABLE_REGISTRATION", "true").
...
func New(ctx context.Context, image string) (Forgejo, error) {
...
func NewWithT(t *testing.T, ctx context.Context, image string) (Forgejo, error) {
